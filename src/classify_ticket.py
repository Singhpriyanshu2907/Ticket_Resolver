...
class classifier:
    ...
    def __init__(self):
        try:
            logger.info("Intializing LLM for Ticket priority classification")
    ...
    def ticket_classifier(self,issue,description):
        ...
        **Output Format:**
        ...
        """
                ...
                logger.info(f"ticket classified sucessfully into {response['choices'][0]['message']['content']} priority category")
